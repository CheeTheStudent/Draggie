label ending_good:
  ...
  show magic black full at attack_mc(0.1)
  ...
  with dissolve
  show magic black at attack_mc(0.2)
  with shakescreen_long
  hide magic

  show magic black at rotation_slow
  with dissolve
  show magic black at attack_mc(0.7)
  with shakescreen_long
  hide magic
  ...
  with dissolve
  show magic black full at attack_mc
  with shakescreen_long
  hide magic with fade
  ...
  "As the teardrop slowly fuses with your flames, you shoot a blast of fire so big at Edgar that you could never imagine you possess."
  ...
  mc "You are right, Darrick. We defeated him for the greater good."

  mc "He will never cause chaos ever again."

  "Darrick kneels next to you and embraces you."

  "You bury your head in Darrick’s embrace, the last few moments of your fight with Edgar drift away from your mind."
...
label ending_best:
  ...
  show darrick angry at left
  show edgar angry tattoo at right
  with move
  ...
  "You head off with Edgar and Darrick out of the Savanna Forest into the night, knowing that the Demon King had a change of heart..." 
  
  "...and with the Guild’s eye as well as yours on him, he will never cause trouble in the world again."
